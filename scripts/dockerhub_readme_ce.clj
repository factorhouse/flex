...
(def readme (slurp "dockerhub/flex-ce/README.md"))
...
(def tags
  ["<!--- StartReleaseLinks --->"
   ""
   (format "* [%s, latest](%s)" release-number "https://github.com/factorhouse/flex/blob/main/dockerfile/flex-ce/Dockerfile")
...
(spit "dockerhub/flex-ce/README.md" next-readme)
